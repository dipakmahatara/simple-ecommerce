    ...
    <div id="application-sidebar-dark" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-gray-900 border-r border-gray-800 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0">
        <div class="px-6">
            <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">SoftBenz Ecommerce</a>
        </div>

        <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="space-y-1.5">
                <li>
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-x-3 py-2 px-2.5 {{ Route::is('dashboard') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white-300' }} text-sm rounded-md">
                ...
                <li>
                    <a href="{{ route('categories.index') }}" class="{{ Route::is('categories.*') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white-300' }} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-400 rounded-md">
                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <li>
                    <a href="{{ route('subcategories.index') }}" class="{{ Route::is('subcategories.*') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white-300' }} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-400 rounded-md">
                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <li>
                    <a href="{{ route('products.index') }}" class="{{ Route::is('products.*') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white-300' }} flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-md ">
