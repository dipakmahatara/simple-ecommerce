...
<div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
    ...
    <header class="flex justify-between items-center mb-8">
        <p class="mb-2 text-sm font-semibold text-blue-600">Products</p>
    ...
    <section>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-200 dark:bg-gray-700">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-400">Subcategory</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-400">Price</th>
        ...
        <div id="add_modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto [--overlay-backdrop:static]" data-hs-overlay-keyboard="false">
            <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-2xl sm:w-full m-3 sm:mx-auto">
                <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <form class="" id="addForm" action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="p-4 overflow-y-auto">
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3 mb-6 md:mb-0">
                                    ...
                                    <input name="name" id="name" class="appearance-none block w-full text-gray-700 focus:border-blue-500 focus:ring-blue-500 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight" type="text" placeholder="Enter product name" required>
                                </div>
                                <div class="w-full md:w-1/2 px-3 mt-4">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="price">
                                        Price
                                    </label>
                                    <input name="price" class="appearance-none block w-full text-gray-700 focus:border-blue-500 focus:ring-blue-500 border border-gray-200 rounded py-3 px-4 leading-tight" id="price" type="number" placeholder="Enter product's price" required>
                                </div>
                                <div class="w-full md:w-1/2 px-3 mt-4">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="subcategory_id">
                                        Select Subcategory
                                    </label>
                                    <select name="subcategory_id" id="subcategory_id" class="py-3 px-4 pr-9 block w-full border border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" required>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full px-3 mt-4">
                                    ...
                                    <textarea name="description" id="description" class="py-3 px-4 block w-full border border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" rows="3" required></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div id="edit_modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto [--overlay-backdrop:static]" data-hs-overlay-keyboard="false">
            <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-2xl sm:w-full m-3 sm:mx-auto">
                <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <form class="" id="updateForm" action="{{ route('products.store') }}" method="POST">
                        <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
                            <h3 class="font-bold text-gray-800 dark:text-white">
                                Edit Product Form
                            </h3>
                        ...
                        <div class="p-4 overflow-y-auto">
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3 mb-6 md:mb-0">
                                    ...
                                    <input name="name" id="edit_name" class="appearance-none block w-full text-gray-700 focus:border-blue-500 focus:ring-blue-500 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight" type="text" placeholder="Enter product name" required>
                                </div>
                                <div class="w-full md:w-1/2 px-3 mt-4">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="edit_price">
                                        Price
                                    </label>
                                    <input name="price" class="appearance-none block w-full text-gray-700 focus:border-blue-500 focus:ring-blue-500 border border-gray-200 rounded py-3 px-4 leading-tight" id="edit_price" type="number" placeholder="Enter product's price" required>
                                </div>
                                <div class="w-full md:w-1/2 px-3 mt-4">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="edit_subcategory_id">
                                        Select Subcategory
                                    </label>
                                    <select name="subcategory_id" id="edit_subcategory_id" class="py-3 px-4 pr-9 block w-full border border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" required>
                                        @foreach ($subcategories as $subcategory)
                                        <option value="{{ $subcategory->id }}">{{ $subcategory->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full px-3 mt-4">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="edit_description">
                                        Description
                                    </label>
                                    <textarea name="description" id="edit_description" class="py-3 px-4 block w-full border border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" rows="3" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-gray-700">
                            ...
                            <button type="submit" id="edit-btn" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-xl border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800" href="#">
                                Update product
                            </button>
                        </div>
                    </form>
    ...
    $('body').on('click', '.btn-edit', function() {
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#edit_subcategory_id').val(response.product.subcategory_id);
                $('#edit_description').val(response.product.description);
                $('#updateForm').attr('action', response.update_route);
                $('#edit-modal-btn').click();
                data_id = '#item-' + response.product.id;
            },
            error: function(response) {
                var errors = response.responseJSON.errors;
                for (var key in errors) {
